...
public class TabeleRFSSumyKontrolneAutomat {
    ...
    TabeleRFSSumyKontrolneAutomat(String paramsPlikWsadowy, String paramsTrzyliterowySkrot , String paramsNazwaDokumentu, String paramsPlanowanaData ,String paramsKatalogDocelowy)
    {
        ...
        try {
          ...
          //  wartoscKoncowa =  paramsIloscPol;
            ...
            outputFile = paramsKatalogDocelowy + "\\Pliki_RFS_Sumy_Kontrolne_" + nazwaPliku +".xls";
...
//            String nazwaPierwszejTabeliLubZakladki = sh1.getRow(1).getCell(params.numerKolumny).getStringCellValue();
            ...
            for (i = wartoscPoczatkowa; i <= 10000; i++)
            {
                ...
                sh1.getRow(three).createCell(2).setCellValue("Sumy Kontrolne");
                sh1.getRow(three).createCell(3).setCellValue(nazwaPliku + " -> "  + "Sumy Kontrolne");


                //P1
                sh1.getRow(four).createCell(1).setCellValue("P" + i);
                sh1.getRow(four).createCell(2).setCellValue("Zakładka: " + "Sumy Kontrolne.\n"
                        + "Kod Sumy Kontrolnej: " + nazwaPola);
                ...
                //Krok 1 [Wiersz 5]
                sh1.getRow(five).createCell(2).setCellValue("Wygeneruj sumę kontrolną " + nazwaPola
                        + " według algorytmu opisanego w kolumnie \'szczegółowy algorytm z uwzględnieniem pól\' ");

                sh1.getRow(five).createCell(1).setCellValue(1);
                sh1.getRow(five).createCell(3).setCellValue("Suma wygenerowana poprawnie");
