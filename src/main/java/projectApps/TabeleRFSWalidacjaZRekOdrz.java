...
public class TabeleRFSWalidacjaZRekOdrz{
    ...
    TabeleRFSWalidacjaZRekOdrz(String paramsPlikWsadowy, String paramsTrzyliterowySkrot ,  String paramsNazwaDokumentu, String paramsPlanowanaData ,String paramsKatalogDocelowy)
    {
        ...
        try {
           ...
           // wartoscKoncowa =  paramsIloscPol;
            ...
            outputFile = paramsKatalogDocelowy + "\\Pliki_RFS_Walidacje_Sum_Kont_Z_Rek_Odrz_" + nazwaPliku +".xls";
...
//            String nazwaPierwszejTabeliLubZakladki = sh1.getRow(1).getCell(params.numerKolumny).getStringCellValue();
            ...
            for (i = wartoscPoczatkowa; i <= 10000; i++)
            {
                ...
                sh1.getRow(three).createCell(2).setCellValue("Walidacja Sum Kontrolnych z rekordami odrzuconymi");
                ...
                sh1.getRow(five).createCell(2).setCellValue("Porównaj " + nazwaPola +  " " + nazwaPolaCzwartego + " " + nazwaPolaDwa
                        +  " + rekordy odrzucone z konsoli rekoncyliacj");
